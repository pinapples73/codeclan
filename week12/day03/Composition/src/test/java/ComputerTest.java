...
public class ComputerTest {
    ...
    public void canOutputDataViaPrinter(){
        ...
        assertEquals("printing: document", computer.outputData("document"));
    }

    @Test
    public void canOutputToSpeaker(){
    ...
    public void canSetOutputDevice(){
        ...
        assertEquals("printing: space invaders", computer.getOutputDevice("space invaders"));
    }
}
