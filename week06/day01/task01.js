...
for (var movie of movies) {
  ...
  var upperCaseTitle = movieTitle.toUpperCase();
  console.log('Movie title:', upperCaseTitle);
}
...
for (var i = 0; i < movies.length; i++) {
  var movie = movies[i];
  var audienceRatings = movie.ratings.audience;

  console.log(`${movie.title} was rated ${audienceRatings} by audiences`);
}
